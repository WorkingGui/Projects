...
I'm a BSc Computer Science student (First Class Honours, Expected 2028) at Oxford Brookes University, specializing in full-stack web development, systems engineering, and cloud infrastructure[cite: 1, 3].

#### 🛠️ Technical Arsenal
* **Languages:** Python, Java, C, C++, JavaScript, TypeScript, SQL, HTML5, CSS3[cite: 1]
* **Frameworks & Tools:** React.js, Node.js, AWS, Git, Docker, Linux, Cisco Packet Tracer, CLI[cite: 1, 3]

#### 🚀 Professional & Team Highlights
* **Web Developer & Systems Engineer @ Coletto Group LTD:** Spearheaded performance optimization for commercial web platforms (e.g., touro.co.uk), reducing page load times by ~25% via React/TypeScript and boosting backend SQL/Node.js query efficiency by ~30%[cite: 1, 4].
...
---
📫 **Connect with me:** [LinkedIn]([linkedin.com/in/guilherme-mendes-aa4a6a398](https://www.linkedin.com/in/guilherme-mendes-aa4a6a398/) | ✉️ itsguimendes@gmail.com
